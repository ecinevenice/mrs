...
class Admin extends Admin_Controller
{
	...
	public function index()
	{
		...
		$is_approver = $this->approvegroup_m->is_division_group_approver($user_id);
		...
		$pagination = create_pagination('admin/approvedivgroup/index', $total_rows, NULL, 4);
		...
		$this->input->is_ajax_request()
			? $this->template->build('admin/approvedivgroup/index')
	...
	{			
		$stat OR redirect('admin/approvedivgroup');
