 ...
 */
class Module_Approvedivgroup extends Module {
	...
	public function info()
	{
		return array(
			'name' => array(
				'en' => 'Approve Division Group Request',
				'ar' => 'المدوّنة',
				'br' => 'Approve Division Group Request',
				'pt' => 'Approve Division Group Request',
				'el' => 'Ιστολόγιο',
				'he' => 'בלוג',
				'id' => 'Approve Division Group Request',
				'lt' => 'Approve Division Group Request',
				'pl' => 'Approve Division Group Request',
				'ru' => 'Approve Division Group Request',
				'zh' => '文章',
				'hu' => 'Approve Division Group Request',
				'fi' => 'Approve Division Group Request',
				'th' => 'บล็อก',
            	'se' => 'Approve Division Group Request',
			),
			'description' => array(
				'en' => 'Review and approve Material Request in your Division Group',
