<fieldset id="filters">
	...
	<?php echo form_hidden('f_module', $module_details['slug']); ?>
		...
		<li>
        		<?php echo lang('approvegroup:status_label', 'f_status'); ?>
			...
			<li>
				<?php echo lang('approvegroup:keywords_label', 'f_status'); ?>
			...
			<li>				
				<?php echo lang('approvegroup:for_approval_label', 'f_for_approval'); ?>
			</li>
