 ...
 */
class Module_Divgroups extends Module {
	...
	public function info()
	{
		return array(
			...
			'description' => array(
				'en' => 'Manage Division Groups. This module allows you to group division that would determine charging for every stock movement. ',
			...
			'sections' => array(
			    'divgroup' => array(
				    'name' => 'divgroup:divgroup_title',
				    'uri' => 'admin/divgroups',
				    'shortcuts' => array(
						array(
					 	   'name' => 'divgroup:create_title',
						    'uri' => 'admin/divgroups/create',
						    'class' => 'add'
						),
					),
				)
