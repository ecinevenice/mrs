...
class Matreq_items_m extends MY_Model
{
	protected $_table = 'material_requests_items';
	...
	public function delete_items($mr_id)
	{
		return $this->db
			->where(array('mr_id' => $mr_id))
			->delete('material_requests_items');
	}
