 ...
 */
class Module_materialrequest extends Module {
	...
	public function info()
	{
		return array(
			...
			'description' => array(
				'en' => 'Material Requesition Module',
			...
			'sections' => array(
			    'posts' => array(
				    'name' => 'matreq:request_title',
				    'uri' => 'admin/materialrequest',
				    'shortcuts' => array(
						array(
					 	   'name' => 'matreq:create_title',
						    'uri' => 'admin/materialrequest/create',
						    'class' => 'add'
						),
					),
				),
