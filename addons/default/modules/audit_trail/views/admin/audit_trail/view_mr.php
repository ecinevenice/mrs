...
<section class="item">
	...
	<h4>Request Details</h4>
		...
		<ul>
			<li> 
				<label for="purpose"><?php echo lang('audit_trail:purpose_label'); ?></label>
			...
			<li>
				<label for="title"><?php echo lang('audit_trail:request_label'); ?></label>
				<div class="input"><?php echo $mr->title; ?></div>				
			</li>
			
			<li>
				<label for="narrative"><?php echo lang('audit_trail:narrative_label'); ?></label>
				<div class="input"><?php echo $mr->narrative; ?></div>
			</li>
			<li>
				<label for="date_needed"><?php echo lang('audit_trail:date_needed_label'); ?></label>
		...
		<li>
		<h4><?php echo lang('audit_trail:mr_history_label'); if($mr_history)
					{ ?></h4>
		<table border="0" class="table-list">
				<thead>
					<tr>
					<th ><?php echo lang('audit_trail:mr_history_date_label'); ?></th>
					<th ><?php echo lang('audit_trail:mr_history_action_label'); ?></th>
					<th ><?php echo lang('audit_trail:mr_history_user_label'); ?></th>
					<th ><?php echo lang('audit_trail:mr_history_remarks_label'); ?></th>
					<th width="100px" ><?php echo " "; ?></th>
				...
				<?php
						...
						{?><div class="no_data"><?php echo lang('audit_trail:no_posts'); }?></div>
