 ...
 */
class Module_Purchases extends Module {
	...
	public function info()
	{
		return array(
			...
			'description' => array(
				'en' => 'SFS Logistics System Module for Purchases ',
			...
			'sections' => array(
			    'transactions' => array(
				    'name' => 'purchases:transaction_label',
				    'uri' => 'admin/purchases/transactions'
				    //~ 'shortcuts' => array(
						//~ array(
				...
				'inquiries_reports' => array(
				    'name' => 'purchases:inquiry_reports_label',
				    'uri' => 'admin/purchases/inquiries_reports'
				    //~ 'shortcuts' => array(
						//~ array(
