 ...
 */
class Module_Items extends Module {
	...
	public function info()
	{
		return array(
			...
			//~ 'sections' => array(
			    //~ 'transactions' => array(
				    //~ 'name' => 'items:transaction_label',
				    //~ 'uri' => 'admin/inventory/transactions'
				    'shortcuts' => array(
						array(
					 	   'name' => 'items:create_title',
				...
				//~ 'inquiries_reports' => array(
				    //~ 'name' => 'inventory:inquiry_reports_label',
				    //~ 'uri' => 'admin/inventory/inquiries_reports'
				    'shortcuts' => array(
						array(
						    'name' => 'items:create_title',
