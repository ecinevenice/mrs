 ...
 */
class Module_Unit_of_Measure extends Module {
		...
		return array(
			...
			'sections' => array(
			    'unit_of_measure' => array(
				    ...
				    'uri' => 'admin/unit_of_measure',
				    'shortcuts' => array(
						array(
					 	   'name' => 'category:create_title',
						    'uri' => 'admin/unit_of_measure/create',
						    'class' => 'add'
						),
					),
				)
	...
	{
		//~ $this->dbforge->drop_table('blog_unit_of_measure');
		//~ $this->dbforge->drop_table('blog');
//~ 
		//~ $tables = array(
			//~ 'blog_unit_of_measure' => array(
