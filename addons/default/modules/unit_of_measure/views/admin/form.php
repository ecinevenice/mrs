	...
	<div class="form_inputs" id="blog-options-tab">
		...
		<ul>
			<li>
				...
				<div class="input">
				<?php echo form_dropdown('category_id', array(lang('blog:no_category_select_label')) + $unit_of_measure, @$post->category_id) ?>
					[ <?php echo anchor('admin/blog/unit_of_measure/create', lang('blog:new_category_label'), 'target="_blank"'); ?> ]
				</div>
			</li>
