<?php if (isset($buttons) && is_array($buttons)): ?>
	...
	<?php foreach ($buttons as $key => $button): ?>
		...
		<?php switch ($button) :
			...
			<!--	<button type="submit" name="btnAction" value="<?php echo $button ?>" class="<?php echo $btn_class; ?> blue" onclick="location.href=''">
					<span><?php echo lang('buttons.' . $button); ?></span>
				</button>-->
			<?php		
				if($btn_class == 'btn') $btn_class .= ' blue';
				$uri = 'admin/' . $this->module_details['slug'].'/submit_requisition/';
