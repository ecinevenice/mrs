...
<div id="sortable">
	...
	<div class="one_half">
		...
		<section class="draggable title">
			<h4><?php echo lang('comments.recent_comments') ?>Pending for your approval</h4>
	...
	<div id="feed" class="one_half">
		...
		<section class="item">
			<ul><li>
				<?php foreach($news_feeds as $news):  ?>
				...
				$status = $this->audit_trail_m->get_mr_history_actions($news->action);?>
					...
					?>						
					<?php $view_link ='admin/special_approver/view_mr/'.$mr->id; ?>
