...
// $config['base_url']	= "http://".$_SERVER['HTTP_HOST']."/mrs_latest/src/";

// //material requisition
// $config['material_requisition'] = $config['base_url'].'index.php'.'/admin/materialrequest/';
...
*/
$config['csrf_protection'] 		= false; // only turn it on for admin panel
