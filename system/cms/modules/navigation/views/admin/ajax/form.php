...
<?php endif; ?>
			...
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="title"><?php echo lang('nav_storage_label');?> <span>*</span></label>
				<?php echo form_input('title', $navigation_link->title, 'maxlength="50" class="text"'); ?>
			</li>
			
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="description"><?php echo lang('nav_storage_desc_label');?> <span>*</span></label>
				<?php echo form_input('description', $navigation_link->description, 'maxlength="50" class="text"'); ?>
			</li>
			...
			<li class="<?php echo alternator('', 'even'); ?>" style="visibility:hidden;">
				<label for="link_type"><?php echo lang('nav_type_label');?></label>
				<!-- TEMP FIX FOR UNWANTED FIELDS-->
				<?php echo form_hidden('link_type', 'page') ?>
				<?php echo form_hidden('page_id', '1') ?>
